(function () {
    ...
    UEDITOR_CONFIG = {
        ...
        toolbars: [
['Source', 'Undo', 'Redo', 'SelectAll', 'Preview', 'InsertImage', 'Emotion', 'Attachment', 'Bold', 'Italic', 'ForeColor', 'FontFamily', 'FontSize', 'BackColor', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyJustify', 'RemoveFormat', 'FormatMatch']
],
        labelMap: {
            'source': '源码', 'undo': '撤销', 'redo': '恢复', 'selectall': '全选', 'preview': '预览', 'insertimage': '图片', 'emotion': '表情', 'attachment': '附件', 'bold': '加粗', 'italic': '斜体', 'forecolor': '文字颜色', 'fontfamily': '字体', 'fontsize': '字号', 'backcolor': '背景颜色', 'justifyleft': '左对齐', 'justifycenter': '居中', 'justifyright': '右对齐', 'justifyjustify': '两端对齐', 'removeformat': '清除格式', 'formatmatch': '格式刷'
        },
        iframeUrlMap: {
